...
#load the environment for cartpole
...
def get_screen():
    screen = env.render(mode='rgb_array').transpose((2, 0, 1))#transpose into torch ordr CHW
    ...
    #remove edges so that we have image centerd on cart
